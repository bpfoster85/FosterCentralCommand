  ...
  return (
    <div style={{ flex: 1, overflow: 'hidden', display: 'flex', flexDirection: 'column', padding: '1rem' }}>
      ...
      <Dialog
        ...
        onHide={closeDialog}
        style={{ width: '90vw', maxWidth: editingProfile ? '560px' : '400px' }}
        dismissableMask
        footer={
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          {editingProfile && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', borderTop: '1px solid var(--sky-border, #e2e8f0)', paddingTop: '1rem' }}>
              <div style={{ fontWeight: 600, fontSize: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <i className="pi pi-flag" /> Goals
              </div>
